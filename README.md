...
SPegetti Slammer is a browser-based 3D game where you roam a sprawling city with a 10-pound sledgehammer and turn pedestrians, bot players, and cars into writhing strands of spaghetti. It is built with [Three.js](https://threejs.org/) and loads from a single static HTML page, so it can be hosted on GitHub Pages.
